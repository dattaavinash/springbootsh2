...
import com.example.spdbconc.domain.Address;
...
public class EmployeeControllerTest {
	...
	public void testCreateEmployeeEntity() throws Exception {
		when(employeeRepository.getEmployeeEntityById(id))
				.thenReturn(Optional.of(new Employee(id,name,company,addressentity)));
